...
1. Read `source/resume.md` to understand the full experience and skills available.
...
5. Write a tailored resume to `tailored/{stem}.md`:
   - Base it entirely on content in `source/resume.md` — do not fabricate or embellish
